    ...
    <div className="flex flex-col md:flex-row min-h-screen">
      ...
      <div className="w-full md:w-1/2 flex items-center justify-center py-12 bg-[#F7FDFF]">
        <div className="max-w-md w-full px-6">
          <H2 className="mb-2 text-center text-gray-800">Welcome back</H2>
          <Body className="text-gray-600 mb-6 text-center">
            Access jobs, manage applications, or connect with talent all in one
            place.
          </Body>
          ...
          <button className="w-full flex items-center justify-center gap-3 border border-gray-300 rounded-md px-4 py-2 mb-4 hover:bg-gray-50 transition">
